...
for (i = 2; i < 62; i++) {
  CalculatePi((i));
  tiemp=(new Date().getTime() - inicio.getTime());
  auxiliar=tiemp-auxiliar;
  document.write(tiemp + "<br>");
}

let final = new Date();

let tiempoFinal = final.getTime() - inicio.getTime();
document.write("<h3>El script ha tardado: </h3>" + tiempoFinal+" milisegundos.");